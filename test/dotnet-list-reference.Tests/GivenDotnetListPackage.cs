...
namespace Microsoft.DotNet.Cli.List.Pacakge.Tests
{
...
Options:
  -h|--help  Show help information";
        ...
        {
            var cmd = new PackageReferenceCommand().Execute(helpArg);
            cmd.Should().Pass();
        ...
        public void WhenNonExistingProjectIsPassedItPrintsErrorAndUsage(string projName)
        {
            ...
            var cmd = new PackageReferenceCommand()
        ...
        public void WhenNoProjectReferencesArePresentInTheProjectItPrintsError()
        {
            ...
            var cmd = new PackageReferenceCommand()
                ...
                .Execute();
            cmd.Should().Pass();
            cmd.StdOut.Should().Be($"There are no Package references in project {lib.CsProjPath}. ;; Package is the type of the item being requested (project, package, p2p) and {lib.CsProjPath} is the object operated on (a project file or a solution file). ");
        }

        [Fact]
        public void ItPrintsSinglePackage()
        {
...
..\ref\ref.csproj";
        ...
        [Fact]
        public void ItPrintsMultiplePackages()
        {
            const string OutputText = @"Project reference(s)
--------------------
..\ref1\ref1.csproj
...
..\ref3\ref3.csproj";
        ...
        // private void AddValidPackage(string packageName, string packageVersion, ProjDir proj)
        // {
